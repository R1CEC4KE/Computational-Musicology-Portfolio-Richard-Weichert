...
Dendrogram: Clustering Swancore Songs {data-navmenu="Dendrogram and Heatmap" data-icon="ion-color-filter-outline"}
=================
Column {data-width=800}
-----------------
...
Heatmap: Identifying Clustering Processes {data-navmenu="Dendrogram and Heatmap" data-icon="ion-color-filter-outline"}
=================
Column {data-width=800}
-----------------
