...
------------
![*Me and a friend with Dance Gavin Dance's screamer, Jon Mess* (Melkweg Amsterdam, 17-03-2023)](Me, Oana, and Jon Mess.jpg){width=400}
...
plotSmallswanpop <- ggplot(SmallSwanpopq, aes(x = Release_Date, y = Danceability, label = Name)) + 
  geom_jitter(aes(fill = Mode,
                  colour = Album),
                  shape = 23, 
                  stroke = 2, 
                  alpha = 0.5, 
