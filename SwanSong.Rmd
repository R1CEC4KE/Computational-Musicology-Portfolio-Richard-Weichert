...
Dendrogram {data-navmenu="Dendrogram and Heatmap"}
=================
...
Heatmap {data-navmenu="Dendrogram and Heatmap"}
=================
Column {data-width=800}
-----------------
...
Totalpopq <- TotalCorpus |>
  summarise(Name = track.name, Album = track.album.name, Artists = track.artists, Release_Date =
      ...
      ), Popularity = track.popularity, Danceability = danceability, Key = key_name, Mode = mode_name, Valence = valence)
...
recluse |>
  ...
  labs(x = "Time (s)", y = "Tempo (BPM)", title = "A Lot Like Birds' - Recluse") +
  theme_classic()
```
